...
public class ProgressWheel extends View {
	 ...
	 * ********* DEFAULTS * **********
	 */
	private boolean isWatchDirection = true;
	...
	private void setupPaints() {
		...
		barPaint.setStrokeJoin(Paint.Join.MITER);
		barPaint.setStrokeCap(Paint.Cap.SQUARE);
		rimPaint.setColor(rimColor);
		rimPaint.setAntiAlias(true);
		rimPaint.setStyle(Style.STROKE);
		rimPaint.setStrokeWidth(rimWidth);
		rimPaint.setStrokeJoin(Paint.Join.MITER);
		rimPaint.setStrokeCap(Paint.Cap.SQUARE);
	}
	
	public void setStrokePaintCap(boolean isRound){
		if(isRound){
	...
	private void setupBounds(int layout_width, int layout_height) {
		...
		if (!fillRadius) {
			...
			circleBounds = new RectF(paddingLeft + barWidth, paddingTop + barWidth, layout_width - paddingRight - barWidth, layout_height
	...
	/**
	* progress 방향을 설정한다.
	* true일 경우 시계방향, false일 경우 반시계 방향
	* @param direction
	*/
	public void setWatchDirection(boolean  direction) {
		isWatchDirection = direction;
	}
