...
public class DeviceFirmwareUpdateActivity extends BaseAppCompatActivity {
    ...
    private void setToolbar() {
        ...
        toolbar.setTitle(R.string.title_device_firmware_update);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(null != intent) {
            serverVersion = intent.getIntExtra("server_firmware",0);
        }
    ...
    private void startDFU(final DfuServiceInitiator starter, final BluetoothDevice device) {
        ...
        String[] list = file.list(new FilenameFilter() {
            ...
            public boolean accept(File dir, String filename) {
                if (filename.indexOf("firmware_"+ serverVersion) > -1) {
                    return true;
                } else {
                    return false;
                }
